...
class Weixin {
    ...
    {
		$contentStr = "亲，欢迎关注肥先生！\n\n欢迎你的体验！\n\n<a href='".WEB_HOST."index.php?m=home&c=index&a=index'>点击访问肥先生</a>";
    ...
    public function receiveEvent($object)
    {
        ...
        {
            case "subscribe"://关注
				$contentStr = "亲，欢迎关注肥先生！\n\n欢迎你的体验！\n\n<a href='".WEB_HOST."index.php?m=user&c=index&a=index&referee=".str_replace("qrscene_","",$object->EventKey)."'>点击访问肥先生</a>";
            ...
            case "unsubscribe"://取消关注
                ...
                break;
			case "SCAN"://扫描二维码
				$contentStr = "亲，欢迎关注肥先生！\n\n欢迎你的体验！\n\n<a href='".WEB_HOST."index.php?m=home&c=index&a=index&referee=".$object->EventKey."'>点击访问肥先生</a>";
